...
export type { ArgsProps, JointContent, MessageType } from "antd/es/message/interface";

export interface NotificationApi {
  success(content: JointContent, duration?: number | VoidFunction, onClose?: VoidFunction): React.Key;
  error(content: JointContent, duration?: number | VoidFunction, onClose?: VoidFunction): React.Key;
  warning(content: JointContent, duration?: number | VoidFunction, onClose?: VoidFunction): React.Key;
  info(content: JointContent, duration?: number | VoidFunction, onClose?: VoidFunction): React.Key;
  loading(content: JointContent, duration?: number | VoidFunction, onClose?: VoidFunction): React.Key;
...
function buildConfig(
  ...
  const base: ArgsProps = isArgsProps
    ? { ...(content as ArgsProps), key }
    : { content, key };
